...
import { updateReview } from "../../../_action/reviewActions";
...
export default function EditReviewForm({ reviewId, initialRating, initialComment, serviceTitle, technicianName }: EditReviewFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setError(res.message || "Failed to update review. Please try again.");
      }
    } catch (err: any) {
  ...
  if (success) {
    return (
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center space-y-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Review Updated!</h2>
        <p className="text-gray-600 font-medium">Your feedback has been successfully updated. Redirecting...</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-semibold text-gray-900">Update your rating</label>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <label className="block text-sm font-semibold text-gray-900">Update your comment</label>
