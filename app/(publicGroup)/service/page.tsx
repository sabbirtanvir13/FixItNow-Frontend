...
//   const response = await getAllServiceData("service", "services-tag");
...
//           <p className="text-gray-500 text-lg font-medium">No services available right now.</p>
//         </div>
//       ) : (
...
//                   />
//                   {/* মূল্যের ব্যাজ ছবির ওপর */}
//                   <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-md px-3 py-1 rounded-xl shadow-sm">
//                     <span className="text-base font-extrabold text-gray-900">
//                       ৳{service.price}
//                     </span>
//                   </div>

//                   {/* ক্যাটাগরি ব্যাজ ছবির ওপর */}
//                   {service.category && (
...
//                         className="w-11 h-11 rounded-full object-cover ring-2 ring-blue-600/20"
//                       />
//                       <div>
...
export default async function ServicesPage({ searchParams }: ServicesPageProps) {
  // Next.js 15+ এ searchParams async
  ...
  // UNIQUE CATEGORIES বের করা Filter Dropdown-এর জন্য
