...
//       <div className="bg-white border rounded-2xl shadow-xl overflow-hidden p-6 md:p-8">
        
    
//         {service.category && (
//           <span className="inline-block bg-blue-50 text-blue-600 text-xs font-semibold px-3 py-1 rounded-md mb-3">
...
//         {/* সার্ভিস বিবরণ */}
//         <div className="mb-8">
//           <h3 className="text-lg font-semibold mb-2 text-gray-800">Service Description</h3>
//           <p className="text-gray-700 leading-relaxed whitespace-pre-line bg-gray-50 p-4 rounded-xl border">
//             {service.description}
//           </p>
//         </div>

//         {/* অতিরিক্ত তথ্য (লোকেশন ও সময়) */}
//         <div className="grid grid-cols-2 gap-4 mb-8">
//           <div className="bg-blue-50/50 p-4 rounded-xl border">
//             <span className="text-sm text-gray-500 block">Service Location</span>
//             <span className="text-base font-semibold text-gray-800">📍 {service.location}</span>
//           </div>
//           <div className="bg-blue-50/50 p-4 rounded-xl border">
//             <span className="text-sm text-gray-500 block">Estimated Duration</span>
//             <span className="text-base font-semibold text-gray-800">⏱️ {service.duration} Minutes</span>
//           </div>
//         </div>

//         {/* টেকনিশিয়ান প্রফাইল কার্ড */}
//         {service.technician && service.technician.user && (
//           <div className="border-t pt-6 mt-6">
//             <h3 className="text-lg font-semibold mb-4 text-gray-800">Assigned Technician</h3>
//             <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-50 p-5 rounded-xl border">
//               <img 
//                 src={service.technician.profilePhoto || "https://via.placeholder.com/150"} 
//                 alt={service.technician.user.name} 
//                 className="w-16 h-16 rounded-full object-cover border-2 border-blue-600"
//               />
//               <div className="flex-1">
//                 <h4 className="text-lg font-bold text-gray-900">{service.technician.user.name}</h4>
//                 <p className="text-sm text-gray-600 mb-2">{service.technician.bio}</p>
//                 <div className="flex flex-wrap gap-2">
//                   {service.technician.skills?.map((skill: string, index: number) => (
//                     <span key={index} className="bg-gray-200 text-gray-700 text-xs px-2.5 py-1 rounded-md">
//                       {skill}
//                     </span>
//                   ))}
//                 </div>
...
//         {/* বুকিং বাটন */}
//         <div className="mt-8">
//           <button className="w-full bg-blue-600 text-white py-3.5 rounded-xl font-semibold hover:bg-blue-700 transition shadow-md">
